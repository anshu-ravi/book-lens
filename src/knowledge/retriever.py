...
from src.knowledge.router import route_query
...
class Retriever:
    ...
    def _fetch_vector_context(
        ...
        """Build formatted context from relevant prose passages.
        ...
        for i, chunk in enumerate(results, 1):
            label = chunk.get("chapter_label", f"Chapter {chunk.get('chapter_index', '?')}")
