...
class RecordedCall:
    ...
    def __init__(self, messages: list[Message], system: str | None, max_tokens: int, temperature: float):
...
class FakeLLM:
    ...
    def complete(
        ...
        *,
        ...
        self.calls.append(RecordedCall(messages, system, max_tokens, temperature))
